      ...
      <c:forEach var="r" items="${allReservations}">
        <tr>
          ...
          <td style="min-width:200px;">
            <form class="d-flex gap-2" method="post" action="<c:url value='/admin/reservation/update'/>">
          ...
          <td><input class="form-control form-control-sm" type="date" name="checkIn" value="${r.checkIn}"></td>
          <td><input class="form-control form-control-sm" type="date" name="checkOut" value="${r.checkOut}"></td>
          <td style="max-width:110px;"><input class="form-control form-control-sm" type="number" min="1" name="guests" value="${r.guests}"></td>
